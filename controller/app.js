...
function koneksiRmq() {
    require('amqplib/callback_api').connect({protocol:'amqp',hostname:'iwkrmq.pptik.id',port:'5672',username:'trainerkit',
    password:'12345678',vhost:'/trainerkit'},function (err,conn) {
       try {
           if (err) {
...
function koneksi() {
    mongo.connect('mongodb://127.0.0.1:27017/IWK',{
